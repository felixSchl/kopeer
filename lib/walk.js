...
module.exports.dir = function(top, options) {
    ...
    return _walkDirectory(top, top, options.filter, options.dereference);
}

function _walkDirectory(top, dir, filter, dereference) {
    return fs.readdirAsync(dir)
        ...
        .map(function(entry) {
            if (entry.stats.isDirectory()) {
                return _walkDirectory(top, entry.filepath, filter, dereference);
            }
            else {
                return entry;
            }
